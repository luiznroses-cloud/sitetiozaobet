                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span><?= $chaveatt['chave'] ?></span>
                                                            <button type="button" class="btn btn-primary btn-clipboard ms-2"
                                                                data-clipboard-text="<?= $chaveatt['chave'] ?>">
                                                                <i class="far fa-copy"></i>
                                                            </button>
                                                        </td>
                                                        <td>
                                                            <span><?= $chaveatt['cpf'] ?></span>
                                                            <button type="button" class="btn btn-primary btn-clipboard ms-2"
                                                                data-clipboard-text="<?= $chaveatt['cpf'] ?>">
                                                                <i class="far fa-copy"></i>
                                                            </button>
                                                        </td>
                                                        <td><?php
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                document.getElementById('btnAprovarSaque').addEventListener('click', function() {
                    ...
                    xhr.open("POST", `services-gateway/payment_manual.php?id=${transacaoId}&usuario=${usuario}`, true);
