...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (update_config($data)) {
        $toastType = 'success';
        $toastMessage = 'Configurações de pixel atualizadas com sucesso!';
    } else {
        $toastType = 'error';
...
<head>
    <?php $title = "Configurações de Pixel";
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Gerenciamento de pixeis de rastreamento</h4>
                            </div>
