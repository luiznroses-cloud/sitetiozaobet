...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $data = [
        ...
        'grupoplataforma' => trim(htmlspecialchars($_POST['grupoplataforma'])),
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="card mb-4">
                                                <div class="card-body">
                                                    <h5 class="card-title">
                                                        <i class="iconoir-percentage-circle"></i> Grupo da plataforma
                                                    </h5>
                                                    <p class="card-subtitle text-muted mb-2">
                                                        Digite o nome do seu grupo no telegram, ele será visualizado dentro página inicial do cassino. Quando usuário tentar entrar em contato com suporte. Obs: Só precisar o nome, Ex: dashoficial
                                                    </p>
