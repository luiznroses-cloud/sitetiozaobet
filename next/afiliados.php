                    ...
                    <div class="col-md-12 col-lg-12">
                                ...
                                <form method="GET" action="">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-4 text-start">
                                            ...
                                            <a href="?" class="btn btn-secondary mt-2">Limpar</a>
                                        </div>
                                    </div>
                                </form>
                                    ...
                                    <table class="table mb-0 table-centered">
                                        ...
                                        <tbody>
                                            ...
                                            if ($result_afiliados && mysqli_num_rows($result_afiliados) > 0) {
                                                ...
                                                echo "<tr><td colspan='10' class='text-center'>Sem dados disponíveis!</td></tr>";
                                            }
                                            ?>
                                        </tbody>
                                    </table><!--end /table-->
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="card-title">Top Afiliado com Mais Indicados</h5>
